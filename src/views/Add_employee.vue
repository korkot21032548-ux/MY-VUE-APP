<template>
    <div class="container mt-4 col-md-4 bg-body-secondary ">
      ...
      <form @submit.prevent="addData">
        <div class="mb-2">
          <input v-model="employees.full_name" class="form-control" placeholder="ชื่อ-นามสกุล" required />
        </div>
        <div class="mb-2">
  ...
  export default {
    ...
    methods: {
      async addData() {
        try {
          const res = await fetch("http://localhost/MY-VUE-APP/php_api/add_employee.php", {
            method: "POST",
